          ...
          <div className="wrap phero__inner phero__inner--legal">
            ...
            <Reveal as="div" delay={2}>
              <p className="lede" style={{ marginTop: "var(--s-4)", maxWidth: "56ch" }}>
                On collecte le minimum, on l&apos;explique clairement, et on ne revend rien.
                Voici le détail, traitement par traitement.
              </p>
            </Reveal>
            ...
            <div className="legal__body">
              ...
              <Reveal className="legal-block" id="donnees">
                ...
                <ul>
                  <li>
                    ...
                    entreprise (facultatif) et contenu du message. Collecte directe auprès de
                    vous.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Prise de rendez-vous (Calendly)</strong> : prénom, nom, email,
                    créneau choisi, notes éventuelles. Collecte directe au moment de la
                    réservation.
                  </li>
                  <li>
                    <strong>Navigation (analytics)</strong> : pages consultées, durée des
                    sessions, source de trafic, type de navigateur (adresse IP anonymisée).
                  </li>
                </ul>
              </Reveal>
              ...
              <Reveal className="legal-block" id="finalites">
                ...
                <ul>
                  ...
                  <li>
                    <strong>Mener une prospection B2B</strong> pertinente vers des décideurs dont
                    la fonction professionnelle correspond à notre offre.
                  </li>
                  <li>
                    <strong>Mesurer l&apos;audience</strong> du site de manière agrégée et
                    améliorer son contenu.
                  </li>
                  <li>
                    <strong>Sécurité du site</strong> : prévenir les abus et atteintes
                    techniques.
                  </li>
                </ul>
              </Reveal>
              ...
              <Reveal className="legal-block" id="base">
                ...
                <ul>
                  <li>
                    <strong>Exécution de mesures précontractuelles</strong> à votre demande
                    (art. 6.1.b RGPD) : formulaire de contact, prise de rendez-vous,
                    inscription au compte ICP Tool.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Intérêt légitime</strong> (art. 6.1.f RGPD) : prospection B2B vers
                    des professionnels, mesure d&apos;audience, sécurité du site.
                  </li>
                  <li>
                    <strong>Obligation légale</strong> (art. 6.1.c RGPD) : conservation des
                ...
                <p>
                  ...
                  prospection ciblée nécessaire à cet intérêt, (3) impact limité sur les droits
                  des destinataires (données professionnelles, opposition possible à tout moment,
                  durée de conservation limitée). Conformément à la recommandation de la CNIL,
                  la prospection vise uniquement des emails professionnels et offre un droit
              ...
              <Reveal className="legal-block" id="duree">
                ...
                <dl>
                  ...
                  <dd>
                    3 ans à compter du dernier contact ou jusqu&apos;à votre opposition
                    (réception immédiate, traitement sous 48 h ouvrées).
                  </dd>
              ...
              <Reveal className="legal-block" id="destinataires">
                ...
                <p>
                  ...
                  exclusivement sur nos instructions et sont liés par un accord de traitement
                  des données (DPA) conforme au RGPD :
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    <strong>Plausible Analytics ehf.</strong> (Estonie, Union européenne) :
                    mesure d&apos;audience sans cookie ni identifiant persistant. Aucun
                    transfert hors UE.
                  </li>
                  <li>
              ...
              <Reveal className="legal-block" id="transferts">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <strong>clauses contractuelles types</strong> (CCT) de la Commission
                    européenne (décision 2021/914), accompagnées de mesures techniques et
              ...
              <Reveal className="legal-block" id="prospection">
                ...
                <p>
                  Nous prospectons par email des professionnels dont la fonction est en lien
                  direct avec nos services. Cette prospection s&apos;appuie sur notre intérêt
                  légitime (art. 6.1.f RGPD), conformément à la recommandation de la CNIL
                  relative à la prospection commerciale par voie électronique.
                </p>
                <p>
                ...
                <p>
                  Si vous recevez un message à une adresse personnelle par erreur, signalez-le
                  par retour de mail : nous supprimerons l&apos;adresse immédiatement.
                </p>
              </Reveal>
              ...
              <Reveal className="legal-block" id="cookies">
                ...
                <p>
                  Ce site n&apos;utilise <strong>aucun cookie publicitaire ni de suivi
                  tiers</strong>. Les seuls cookies déposés sont strictement nécessaires au
                  fonctionnement du site (session, préférences techniques).
                </p>
                <p>
                  La mesure d&apos;audience est assurée par{" "}
                  <strong>Plausible Analytics</strong>, outil européen privacy-first qui ne
                  dépose aucun cookie et n&apos;utilise pas d&apos;identifiant persistant. Cet
                  outil bénéficie de l&apos;exemption de consentement reconnue par la CNIL pour
                  les solutions de mesure d&apos;audience strictement anonymes.
                </p>
              </Reveal>
              ...
              <Reveal className="legal-block" id="profilage">
                ...
                <p>
                  ...
                  automatisée, ni de profilage, produisant des effets juridiques à votre égard
                  ou vous affectant de manière significative (art. 22 RGPD).
                </p>
              </Reveal>
              ...
              <Reveal className="legal-block" id="droits">
                ...
                <ul>
                  ...
                  <li>
                    <strong>Droit de rectification</strong> (art. 16) : faire corriger des
                  ...
                  <li>
                    <strong>Droit à la limitation</strong> (art. 18) : restreindre temporairement
                    le traitement.
                  </li>
                  <li>
                    <strong>Droit d&apos;opposition</strong> (art. 21) : refuser un traitement
                    fondé sur l&apos;intérêt légitime, notamment la prospection.
                  </li>
                  <li>
                    <strong>Droit à la portabilité</strong> (art. 20) : récupérer vos données
                ...
                <p>
                  ...
                  <a href="mailto:hello@rezus.agency">hello@rezus.agency</a> en précisant le
                  droit que vous souhaitez exercer. Nous vous répondrons dans un délai maximum
                  de <strong>30 jours</strong>, conformément à l&apos;article 12.3 du RGPD.
                </p>
                <p>
              ...
              <Reveal className="legal-block" id="conséquences">
                ...
                <p>
                  Les données marquées comme obligatoires dans nos formulaires sont nécessaires
                  pour traiter votre demande. Si vous refusez de les fournir, nous ne pourrons
                  pas répondre à votre sollicitation, créer votre compte, ou organiser un
                  rendez-vous.
                </p>
              </Reveal>
              ...
              <Reveal className="legal-block" id="modifications">
                ...
                <p>
                  ...
                  haut de la page. Pour toute modification substantielle, nous vous en
                  informerons par les canaux appropriés.
                </p>
              </Reveal>
            </div>
          </div>
